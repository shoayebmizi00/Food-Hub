// Store dashboard page placeholder.
...
const navItems = [
  ...
  { path: '/store/orders', label: 'Orders', icon: Package },
  { path: '/store/inventory', label: 'Inventory', icon: Warehouse },
  { path: '/store/expenses', label: 'Expenses', icon: Receipt },
    ...
    return (
      <div className="min-h-screen pt-20 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-4">You need restaurant owner access.</p>
    ...
    <div className="min-h-screen pt-16 flex">
      <aside className="hidden lg:flex w-64 flex-col bg-card border-r border-border fixed top-16 bottom-0 left-0 z-30">
        <div className="p-4 border-b border-border">
          <h2 className="font-bold text-sm">Store Manager</h2>
